...
const Ttoken = process.env.botToken;
...
const mainKeyboard = Markup.inlineKeyboard([
	...
	Markup.urlButton('ידיעון', process.env.yedionUrl),
	...
	ctx.reply(txtData.qna4,
		Extra.markup(
			Markup.inlineKeyboard([
				...
				Markup.urlButton('אני מבין וקראתי את החוקים', process.env.yoasimUrl),
	...
	ctx.editMessageText(txtData.terapia,
		Extra.markup(
			Markup.inlineKeyboard([
				...
				Markup.urlButton('אני מבין וקראתי את החוקים', process.env.yoasimPTUrl),
				Markup.callbackButton('לתפריט הראשי', 'restart'),
			],
			{
				columns: 1
